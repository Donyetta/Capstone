...
export default state => html`
  <section id="visitors">
    ...
    <h2>DISQUALIFIERS:</h2>
    <p>
      Being identified in the foreign fugitive file. <br />
      Identified in the Immigration Violator File. <br />
      In the Known or Appropiately Suspected Terrorist File. <br />
      Felony convictions for Rape, Child Molestation, Trafficking in Humans,
      Espionage, Sabotage, Treason or Terrorism. <br />
      Being identified in the National Sex Offender Registry. <br />
      Any felony conviction within the past ten years (other than listed above).
    </p>

    <h3>FOR SPONSORS:</h3>
    <p>
      Sponsors are identified as : Retirees, DOD Civilian CAC Holders, and
      Active Military. <br />
